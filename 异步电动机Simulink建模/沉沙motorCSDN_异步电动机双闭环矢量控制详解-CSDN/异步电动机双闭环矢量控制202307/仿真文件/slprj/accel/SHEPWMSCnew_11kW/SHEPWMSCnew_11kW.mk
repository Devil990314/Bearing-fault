...
MODEL              = SHEPWMSCnew_11kW
MODULES            = SHEPWMSCnew_11kW_acc_data.c rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c rt_zcfcn.c 
MAKEFILE           = SHEPWMSCnew_11kW.mk
MATLAB_ROOT        = D:/program/matlab2015b
ALT_MATLAB_ROOT    = D:/program/matlab2015b
MASTER_ANCHOR_DIR  = 
START_DIR          = D:/BaiduNetdiskDownload/异步电机双闭环矢量控制详解/异步电机双闭环矢量控制详解/仿真文件
MATLAB_BIN         = D:/program/matlab2015b/bin
ALT_MATLAB_BIN     = D:/program/matlab2015b/bin
...
MEX_OPT_FILE       = -f D:/program/matlab2015b/rtw/c/tools/lcc-win64.xml
OPTIMIZATION_FLAGS = -DNDEBUG
ADDITIONAL_LDFLAGS = 

#--------------------------- Model and reference models -----------------------
MODELLIB                  = SHEPWMSCnew_11kWlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/accel/SHEPWMSCnew_11kW \
	-I$(START_DIR) \
	-ID:/project/SHEPWM仿真4月21日/SHEPWM仿真 \
